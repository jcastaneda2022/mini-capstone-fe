...
export default function AdminBlogs() {
  ...
  function MyDropzone(blog) {
    ...
    const onDrop = useCallback((acceptedFiles) => {
      ...
      axios
        .put(
          `http://ec2-18-136-126-149.ap-southeast-1.compute.amazonaws.com:8080/blog/${blog.blogId}/upload`,
          formData,
          {
            headers: {
    ...
    return (
      <div className="card h-100 text-center p-4">
        <img
          src={
            blog.imageLink
              ? `http://ec2-18-136-126-149.ap-southeast-1.compute.amazonaws.com:8080/blog/${blog.blogId}/download`
