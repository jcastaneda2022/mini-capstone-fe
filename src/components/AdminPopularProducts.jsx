...
export default function AdminPopularProducts() {
  ...
  function MyDropzone(product) {
    ...
    const onDrop = useCallback((acceptedFiles) => {
      ...
      axios
        .put(
          `http://ec2-18-136-126-149.ap-southeast-1.compute.amazonaws.com:8080/popular/${product.productId}/upload`,
          formData,
          {
            headers: {
    ...
    return (
      <div className="card h-100 text-center p-4">
        <img
          src={
            product.imageLink
              ? `http://ec2-18-136-126-149.ap-southeast-1.compute.amazonaws.com:8080/popular/${product.productId}/download`
